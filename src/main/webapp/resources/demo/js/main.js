...
(function(html) {
    ...
    const cfg = {
        ...
        finalDate : 'January 16, 2023 00:00:00',
        // MailChimp URL
         mailChimpURL : 'https://genpen.us21.list-manage.com/subscribe/post?u=7d4a815265d35857eaf46b20a&id=9dce1d1679&f_id=00b9c9e1f0'
    ...
    * -------------------------------------------------- */
    ...
    function longToBase32(long) {
        ...
        while (quotient > 0) {
            ...
            base32String = base32.charAt(remainder) + base32String;
        }
    ...
    * ------------------------------------------------------ */
    const ssCountdown = function () {
        ...
        const bigNumber = document.querySelector('#count_down');
        let timeInterval;
        ...
        function timer() {
            ...
            bigNumber.textContent = longToBase32(now + now);
	    ...
	    */
        ...
        timer();
        timeInterval = setInterval(timer, 500);
    };
